...
- [ ] Crear `frontend/src/api/reportes.ts`.
- [ ] Crear `frontend/src/hooks/useResumenDashboard.ts` con `staleTime` corto.
- [ ] Crear `frontend/src/pages/Dashboard/Dashboard.tsx` con selector de periodo, tarjetas de totales y gráfica.
