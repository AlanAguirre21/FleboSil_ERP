...
11. Frontend — crear `frontend/src/api/personas.js` con funciones CRUD de los cuatro tipos.
12. Frontend — crear hooks `useClientes.js`, `useProveedores.js`, `useEmpleados.js`, `useUsuarios.js` con React Query.
13. Frontend — crear `frontend/src/pages/Personas/Personas.jsx` con selector de pestañas (Clientes / Proveedores / Empleados / Usuarios).
...
17. Frontend — agregar la ruta `/personas` en `App.jsx`.
