...
- [ ] El admin puede crear, editar y desactivar cuentas contables, cada una con código, nombre y tipo (activo/pasivo/capital/ingreso/egreso), con soporte de jerarquía