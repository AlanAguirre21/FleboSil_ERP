...
- [ ] Crear `frontend/src/api/compras.js` con las funciones necesarias.
- [ ] Crear `frontend/src/hooks/useCompras.js`, invalidando cache de `useInventario` tras recibir/cancelar.
- [ ] Crear `frontend/src/pages/Compras/Compras.jsx` con lista filtrable.
- [ ] Crear `frontend/src/pages/Compras/NuevaCompra.jsx` con selector de proveedor/sucursal y líneas dinámicas.
- [ ] Crear `frontend/src/pages/Compras/DetalleCompra.jsx` con botones de acción según estado.
- [ ] Agregar la ruta `/compras` en `App.jsx` y el módulo al diccionario "módulo → roles permitidos" (sin restricción de rol).
