...
- [ ] Crear `frontend/src/api/caja.js` con listado filtrable y creación de movimiento manual.
- [ ] Crear `frontend/src/hooks/useMovimientosCaja.js`.
- [ ] Crear `frontend/src/pages/Caja/Caja.jsx` con saldo destacado, tabla filtrable y botón de registro manual.
...
- [ ] Agregar la ruta `/caja` en `App.jsx`, protegida exclusivamente para admin.
