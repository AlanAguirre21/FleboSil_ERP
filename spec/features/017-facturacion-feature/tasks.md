...
- [ ] Crear `frontend/src/api/facturacion.js`.
- [ ] Crear `frontend/src/hooks/useFacturas.js`.
- [ ] Modificar `DetalleVenta.jsx` para habilitar el botón "Generar factura" condicionalmente.
- [ ] Crear `frontend/src/pages/Facturacion/Facturacion.jsx` con lista filtrable.
...
- [ ] Agregar la ruta `/facturacion` en `App.jsx` y el módulo al diccionario "módulo → roles permitidos" (sin restricción de rol).
