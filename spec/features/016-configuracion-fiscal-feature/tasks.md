...
- [ ] Crear `frontend/src/api/configuracionFiscal.js`.
- [ ] Crear `frontend/src/hooks/useConfiguracionFiscal.js`.
- [ ] Crear `frontend/src/pages/ConfiguracionFiscal/ConfiguracionFiscal.jsx` con los tres formularios/tablas.
...
- [ ] Agregar la ruta `/configuracion-fiscal` en `App.jsx` y el módulo al diccionario "módulo → roles permitidos" (solo admin).
