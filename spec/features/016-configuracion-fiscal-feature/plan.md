...
10. Frontend — crear `frontend/src/api/configuracionFiscal.js` con funciones de consulta/actualización de los tres recursos.
11. Frontend — crear `frontend/src/hooks/useConfiguracionFiscal.js` con React Query.
12. Frontend — crear `frontend/src/pages/ConfiguracionFiscal/ConfiguracionFiscal.jsx`: formulario de datos fiscales de la empresa, formulario de conexión al PAC (con campo de API key enmascarado tipo password), tabla de series/folios con alta/edición.
13. Frontend — implementar el indicador visual de "configuración incompleta" si falta algún dato fiscal o credencial del PAC.
14. Frontend — agregar la ruta `/configuracion-fiscal` en `App.jsx`, protegida exclusivamente para admin.
