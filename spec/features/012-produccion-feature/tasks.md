...
- [ ] Crear `frontend/src/api/produccion.js`.
- [ ] Crear `frontend/src/hooks/useRecetas.js` y `useProducciones.js`, invalidando cache de inventario.
- [ ] Crear `frontend/src/pages/Produccion/Produccion.jsx` con selector de secciones.
...
- [ ] Agregar la ruta `/produccion` en `App.jsx` y el módulo al diccionario "módulo → roles permitidos".
