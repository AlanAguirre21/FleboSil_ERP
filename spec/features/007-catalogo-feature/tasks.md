...
- [ ] Crear `frontend/src/api/catalogo.ts` con funciones CRUD de los tres tipos.
- [ ] Crear `frontend/src/hooks/useCategorias.ts`, `useProductos.ts`, `useMateriaPrima.ts`.
- [ ] Crear `frontend/src/pages/Catalogo/Catalogo.tsx` con selector de pestañas.
...
- [ ] Agregar la ruta `/catalogo` en `App.tsx`.
