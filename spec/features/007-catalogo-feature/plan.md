...
9. Frontend — crear `frontend/src/api/catalogo.js` con funciones CRUD para los tres tipos.
10. Frontend — crear `frontend/src/hooks/useCategorias.js`, `useProductos.js`, `useMateriaPrima.js` con React Query.
11. Frontend — crear `frontend/src/pages/Catalogo/Catalogo.jsx` con selector de pestañas (Productos / Materia Prima / Categorías) que renderiza la tabla correspondiente usando el componente común `Tabla`.
...
14. Frontend — agregar la ruta `/catalogo` en `App.jsx`, protegida y dentro de `MainLayout`.
